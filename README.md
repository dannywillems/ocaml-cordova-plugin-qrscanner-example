# ocaml-cordova-plugin-qrscanner-example

This is an example of the binding to the *qrscanner cordova plugin*. See the
binding [here](https://github.com/dannywillems/ocaml-cordova-plugin-qrscanner)

**This plugin is ONLY available on ios !!!**

**Please read the documentation and the original plugin first to know how to use
it. If no documentation is present, read the interface file.**
...
You need to install the plugin *cordova-plugin-qrscanner*. The Makefile contains
...
* init_plugins: initialize plugins you need. Contains cordova-plugin-qrscanner
  for this project.
